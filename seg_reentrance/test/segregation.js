...
contract('Re-entrancy test', async (accounts) => 
{
    ...
    describe('get() test', () => 
    {
        it('attacker uses the re-entrancy bug to drain funds', async () => 
        {
            ...
            var _dataAddressFromLogi = await honeyPotLogic.getDataAddress();
            console.log(`data address received from logic contract: ${_dataAddressFromLogi}`);
            // await honeyPotLogic.topup(
            //     { 
            //         from: user1, 
            ...
            // console.log('honeyPotLogic balance before put: ' + honeyPotLogicBalance / ether);
